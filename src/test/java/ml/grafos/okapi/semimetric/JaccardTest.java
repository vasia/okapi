...
import ml.grafos.okapi.semimetric.similarity.JaccardWeighting;
...
public class JaccardTest {
  ...
  public void testExactSimilarity() {
    ...
    conf.setComputationClass(JaccardWeighting.SendFriendsList.class);
    conf.setMasterComputeClass(JaccardWeighting.MasterCompute.class);
