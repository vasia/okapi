...
public class TestCalculateAlternativePaths {
	...
	/**
	 * Test removing a metric edge and having 2 alternative paths
	 * with one semi-metric edge (BFSs to run: 2).
	 */
	@Test
	public void testMetricRemoval() throws Exception {
        ...
        // run internally
        Iterable<String> results = InternalVertexRunner.run(conf, null, graph);
        System.out.println("Testing removal of a metric edge");
        for (String s: results) {
        	// print results
        	System.out.println(s);
        }
	...
	/**
	 * Test removing a metric edge and having 2 alternative paths
	 * with three semi-metric edges (BFSs to run: 4).
	 */
	@Test
	public void testMetricRemovalWithThreeSemimetricEdges() throws Exception {
        String[] graph = new String[] {
        		"1	2	false", "2	1	false",
        		"1	3	true",  "3	1	true",
        		"1	6	false",  "6	1	false",
	...
	/**
	 * Test removing a metric edge and having no alternative paths.
	 */
	@Test
	public void testMetricRemovalNoPaths() throws Exception {
        String[] graph = new String[] {
        		"1	2	false", "2	1	false",
        		"1	3	true",  "3	1	true",
        		"1	6	false",  "6	1	false",
        ...
        // run internally
        Iterable<String> results = InternalVertexRunner.run(conf, null, graph);
        System.out.println("Testing removal of a metric edge with no alternative paths");
        for (String s: results) {
        	// print results
        	System.out.println(s);
        }
