...
public class TestOptimizedParallelMetricBFS {
	...
	public void testOneUnlabeledSemimetric() throws Exception {
        ...
        conf.setMasterComputeClass(OptimizedParallelMetricBFS.MasterCompute.class);
        conf.setComputationClass(OptimizedParallelMetricBFS.Initialize.class);
